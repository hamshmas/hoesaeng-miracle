...
const BV2_CONTENT = {
  ...
  hero: {
    ...
    h2: '변호사 본인이 끝까지.',
    body: '사무장이 아니라 **도산전문변호사가 직접** 검토합니다. **2,321건**의 성공사례와 **94.18%** 탕감 인가사례로 증명합니다.',
    cta: '변호사 직접 회신 받기',
  ...
  lawyer: {
    ...
    creds: [
      ...
      { k: '실적', v: '회생/파산 누적 2,321건+' },
      { k: '미디어', v: '유튜브 "회생의기적" 25,700명 · 로톡 등록 370건' },
    ],
  },

  stats: [
    { n: '2,321', suf: '건+', l: '누적 성공 사례', sub: '2026.6 기준', src: 'blackstonelaw.co.kr' },
    { n: '25,700', suf: '명', l: '유튜브 "회생의기적"', sub: '구독자', src: 'youtube.com/@개인회생' },
    { n: '375', suf: '건', l: '네이버 카페 후기', sub: '실제 의뢰인 후기', src: 'cafe.naver.com' },
    { n: '370', suf: '건', l: '로톡 등록 성공사례', sub: '법률사례', src: 'lawtalk.co.kr' },
  ],
  ...
  nationwide: {
    ...
    steps: [
      ...
      { k: '2', l: '계약', t: '전자계약서로 진행' },
      { k: '3', l: '1차 서류 제출', t: '동사무소 발급 서류' },
      { k: '4', l: '2차 서류 대리 발급', t: '40여종 문서 대리 발급' },
      { k: '5', l: '변호사 검토', t: '신청서 작성·검토' },
      { k: '6', l: '법원 제출', t: '변호사 직접 접수' },
    ],
