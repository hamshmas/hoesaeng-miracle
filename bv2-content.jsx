...
const BV2_CONTENT = {
  ...
  lawyer: {
    name: '이승진',
    title: '대표 변호사 · 도산 전문',
    bio: '서울대 공대를 우등졸업하고, 도산 전문 변호사로 등록한 이후 6년간 회생·파산 사건만 다뤄왔습니다. 의뢰인 한 분당 평균 4회 이상 직접 상담합니다.',
    creds: [
  ...
  handwritten: [
    { title: '다시 한번 가장이 될 수 있는 기회를 주셨습니다', preview: '아내와 두 아이를 보면서, 다시는 일어설 수 없을 것 같았습니다. 변호사님께서 끝까지 포기하지 않으시고…' },
    { title: '전세사기 피해자도 살아갈 기회가 생기네요', preview: '전세금 사기로 한순간에 모든 걸 잃었습니다. 다른 곳에서는 안 된다고만 했는데…' },
    { title: '학원 운영 채무를 해결할 수 있어서 기분이 좋습니다', preview: '코로나로 학원 매출이 절반 이하로 떨어졌습니다. 빚만 늘어가는 상황에서…' },
    { title: '막대한 병원비 채무 해결하게 해 주셔서 감사합니다', preview: '갑작스러운 큰 수술과 입원으로 병원비만 1억이 넘었습니다. 카드 돌려막기를…' },
    { title: '주식 리딩방 사기 당한 후 다시 살아갈 기회를 주셨습니다', preview: '리딩방을 믿고 대출까지 받아 투자했다가 모든 걸 잃었습니다…' },
    { title: '블랙스톤 덕분에 새 삶을 선물 받을 수 있었습니다', preview: '인가 결정 나던 날, 가족 모두가 눈물을 흘렸습니다. 변호사님 정말 감사합니다…' },
  ],
